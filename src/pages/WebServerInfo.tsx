...
const WebServerInfo = () => {
  ...
  const handleSubmit = async (query: string) => {
    ...
    try {
      ...
      const ip = aRecord?.Answer?.[0]?.data || 'N/A';
      ...
      setResults(
        <div className="space-y-4">
          <ResultsTable
            ...
            items={[
              { label: 'IP Address', value: ip, status: 'info' },
  ...
  return (
    <ToolPageLayout
      ...
      description="Retrieve HTTP status, detect technology stack, and measure response time."
      features={[
